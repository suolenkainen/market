...
needs_path = PATH + "\\src\\resources\\needs.csv"
priority_path = PATH + "\\src\\resources\\priority.csv"
...
NEEDS = utils.csv_to_dict_converter(needs_path)
PRIORITIES = utils.csv_to_dict_converter(priority_path)
